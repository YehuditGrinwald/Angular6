...
export class AppComponent implements OnInit {
  ...
  addInitialCategory(category: Category) {
    console.log('addInitialCategory');
...
console.log('init');
   let initCat = new Category();
    ...
    initTodo = { 'title': 'Task1', 'completed': false, 'id': 1, category: 1 };
    this.addInitialTodo(initTodo);
    initTodo = { 'title': 'Task2', 'completed': true, 'id': 2, category: 2 };
    this.addInitialTodo(initTodo);
    initTodo = { 'title': 'Task3', 'completed': true, 'id': 3, category: 1 };
    this.addInitialTodo(initTodo);
  }
